...
# Chỉ import đúng một mình PayOS - Tuyệt đối không import các kiểu Data cũ
try:
...
# API Key xóa nền thật của Photoroom (Thay mã prod_... của anh vào đây nhé)
...
if uploaded_file is not None:
    ...
    if not st.session_state.payment_success:
        ...
        if st.button("🚀 Khởi Tạo Mã QR Chuyển Khoản (5.000đ)"):
            try:
                # Ép toàn bộ thông tin đơn hàng thành 1 biến Dictionary duy nhất theo đúng chuẩn
                payment_data = {
                ...
                # Gọi hàm với duy nhất một biến đầu vào
